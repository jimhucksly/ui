<template>
  <v-container
    class="b-select-list-box"
    :class="[`b-select-list-box--${mySize}`, `b-select-list-box--${color}`, { 'b-select-list-box': labelOnTop }]"
  >
    <v-row no-gutters>
        ...
        <div class="d-flex align-start">
          ...
          >
            ...
            <template #loader v-if="loading">
              <div class="b-select-list-box-loader"></div>
            </template>
            <template #append>
...
<script src="./b-select-list-box.ts"></script>
