<template>
  <v-container
    ...
    :class="[
      ...
      `b-timepicker--${color}`,
      {
        'b-timepicker--focused': isFocused,
        'b-timepicker--label-on-top': labelOnTop,
      },
    ]"
  >
    <v-row no-gutters>
      ...
      <v-col :class="inputSizeClasses">
        <div class="d-flex align-start">
          ...
          >
            ...
            <v-card elevation="0" class="b-timepicker-dropdown">
              <v-container class="pa-0">
                <v-row no-gutters v-if="!is24hr" class="mb-1">
                  <v-col class="b-timepicker-ampm">
                    <v-btn :active="isAM" @click="setAmPm('am')">am</v-btn>
                    <v-btn :active="isPM" @click="setAmPm('pm')">pm</v-btn>
                  </v-col>
                </v-row>
                <v-row no-gutters class="mb-1">
                  <v-col class="b-timepicker-placeholder" style="color: var(--grey-d-1); height: var(--icon-height)">
                ...
                <v-row no-gutters class="mb-1">
                  <v-col class="b-timepicker-inputs">
                    <component
                      :is="$ui.options.aliases['b-edit-text']"
                      :id="`timeinput-h-${uid}`"
                      ref="timeinput-h"
                ...
                <v-row no-gutters>
                  <v-col class="b-timepicker-options">
...
<script src="./b-timepicker.ts"></script>
