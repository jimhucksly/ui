<template>
  <v-container
    ...
    :class="[
      `b-edit-text--${mySize}`,
      `b-edit-text--${color}`,
      { 'b-edit-text--focused': isFocused, 'b-edit-text--label-on-top': labelOnTop },
    ]"
  >
    <v-row no-gutters>
      ...
      <v-col :class="inputSizeClasses">
        ...
        <div class="d-flex align-start" v-if="!onlyNumbers">
          <v-text-field
            ...
            :class="{ 'b-edit-text--type-password': type === 'password' && !passwordVisible }"
            :rules="validRules"
...
<script src="./b-edit-text.ts"></script>
