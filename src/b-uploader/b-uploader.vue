    ...
    <v-card-text class="d-flex flex-column" :class="{ 'h-100': fullHeight }">
      ...
      >
        ...
        <div class="d-flex" :class="{ 'flex-column align-center mb-1': size !== 's', 'justify-center': size === 's' }">
          ...
          <div class="b-uploader-placeholder">
      ...
      <div class="b-uploader-items" v-if="hasItems && !asInput">
        <ul>
          <li v-for="item of items" :key="item.uid">
            <div class="b-uploader-item">
              <div class="b-uploader-item-icon flex-shrink-0">
              ...
              <div class="d-flex flex-column flex-grow-1 pl-3" style="max-width: 100%">
                ...
                <component
                  ...
                  :is="$ui.options.aliases['b-progress']"
                  :value="item.progress"
                  :counter="false"
                  :label="null"
                  class="b-uploader-progress"
                />
              </div>
              <!-- buttons -->
...
<script src="./b-uploader.ts"></script>
