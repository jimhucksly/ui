<template>
  <div class="b-step" :class="[`b-step--${myDirection}`]">
    <template v-if="hasItems">
      <div
        ...
        class="b-step-item"
        :class="[
          `b-step-item--${item.result ? item.result : item.type ? item.type : 'default'}`,
          { 'b-step-item--disabled': item.disabled },
        ]"
      >
        <div class="b-step-item-icon" v-if="item.result || item.type">
        ...
        <div class="b-step-item-title">
          <span>{{ item.title }}</span>
          <div class="b-step-item-subtitle" v-if="item.subtitle">
            {{ item.subtitle }}
          </div>
        </div>
      </div>
