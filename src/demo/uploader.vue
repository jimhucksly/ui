        ...
        <b-tab index="0" heading="Playground">
          <v-row class="pt-3">
            ...
            <v-col cols="3">
              ...
              <b-switch label="max" v-model="max" hide-details />
              ...
              <b-switch label="multiple" v-model="multiple" hide-details />
              <b-switch label="lazy load" v-model="lazy" hide-details />
              <b-switch label="as input" v-model="asInput" hide-details />
              <b-switch label="drop" v-model="drop" hide-details />
              <b-switch label="use before send handler" v-model="before" hide-details />
              <div style="width: 300px" class="d-flex mb-1">
                <b-edit-text v-model="url" :disabled="!setUrl" label="url" hide-details />
                <b-switch v-model="setUrl" class="ml-2" hide-details />
              </div>
              <b-button @click="save">validate</b-button>
            </v-col>
            <v-col cols="4">
              <div style="width: 300px" class="d-flex mb-1">
                <b-edit-text only-numbers v-model="width" :disabled="!setWidth" label="width (px)" hide-details />
                <b-switch v-model="setWidth" class="ml-2" hide-details />
              </div>
              <div style="width: 300px" class="d-flex mb-1">
                <b-edit-text only-numbers v-model="height" :disabled="!setHeight" label="height (px)" hide-details />
                <b-switch v-model="setHeight" class="ml-2" hide-details />
              </div>
              <b-radiogroup v-model="size" label="size" label-on-top hide-details>
                <b-radiobutton value="s" label="small" />
                <b-radiobutton value="m" label="medium" />
