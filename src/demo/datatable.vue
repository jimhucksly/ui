                  ...
                  >
                    ...
                    <template #cell-header:append="{ column, hover }">
                      <v-menu v-model="menu[column.prop]" :close-on-content-click="false">
                        <template #activator="{ props }">
                          <b-button icon text v-if="hover" v-bind="props">
                            <b-icon>filter</b-icon>
                          </b-button>
                        </template>
                        <v-card width="300" class="pa-3">
                          <v-card-text class="pa-0">
                            <b-edit-text label="Поиск" hide-details></b-edit-text>
                          </v-card-text>
...
import { CreateEditDialog } from '@/b-dialog/dialogs';
