...
**awaiting**
```js
import { awaiting } from '@dn-web/ui';
async function() {
  let a = 0;
  setTimeout(() => {
    a = 1;
...
**isDefined**
```js
import { isDefined } from '@dn-web/ui';
 ...
 */
import { deepValueGetter } from '@dn-web/ui';
const Record = {
  Key1: {
    Key2: {
      Key3: value
...
import { removeDuplicates } from '@dn-web/ui';
const arr = [
  {
    record: 1,
    company: 'lanit'
...
**isObjectEmpty**
```js
import { isObjectEmpty } from '@dn-web/ui';
const obj = {};
 ...
 * ): string;
 */
import { pluralizeNoun } from '@dn-web/ui';
